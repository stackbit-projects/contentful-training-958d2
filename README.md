...
1. Navigate to ["API keys" Settings page](https://app.contentful.com/spaces/q7j3l85u7v6h/api/cma_tokens) of your Contentful space and generate new "Personal Access Token"
...
To start editing your site, you can use the Contentful interface at [https://app.contentful.com/spaces/q7j3l85u7v6h](https://app.contentful.com/spaces/q7j3l85u7v6h).
...
Generated at `2021-12-02T23:41:07.975Z` by Stackbit version `0.3.55`.